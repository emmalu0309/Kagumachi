...
const NavBar = () => {
  ...
  const handleChatClick = () => {
    // 觸發 MemberInfoNavbar 的 handleChatClick
    const event = new CustomEvent("chatClick");
  ...
  return (
    <div>
      <div className="w-[95%] flex mx-auto my-6 items-center">
        ...
        >
          <Link to="/homepage">{navbar.websitename}</Link>
        </div>
        ...
        {user ? (
          <Link to="/MemberInfo/Chat" onClick={handleChatClick}>
