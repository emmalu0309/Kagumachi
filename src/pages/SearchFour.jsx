...
export default function SearchFour() {
    ...
    return (
        <div className="p-2 w-11/12 mx-auto">
            <div className="flex  mb-4 border p-2 mx-auto w-11/12 text-sm">
                <div>
            ...
            <div className="mt-2 flex justify-end space-x-4 border w-11/12 mx-auto">
                <button
                    ...
                    className="px-4 py-2 bg-gray-300 text-white rounded disabled:bg-gray-100"
                >
                    上一頁
                </button>
            ...
            <h1 className="text-xl font-bold mb-4 p-2">商品列表</h1>
